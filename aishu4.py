...
def data_get():
    city = city_name.get()
    data = requests.get(
    "https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=14ede64310d6176b1992463300b74494").json()
...
win = Tk()
win.title('Wscube_Aishu')
win.config(bg = 'blue')
win.geometry('500x520')

name_label = Label(win, text='Wecube Weather app',
...
city_name = StringVar()
com = ttk.Combobox(win, text='Wecube Weather app',values=list_name,
